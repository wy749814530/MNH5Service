...
import mn.zxing.camera.CameraManager;
import mn.zxing.decoding.CaptureActivityHandler;
import mn.zxing.decoding.InactivityTimer;
import mn.zxing.helper.ImageAnalyzeLinstener;
import mn.zxing.helper.ScanResultLinstener;
import mn.zxing.utils.ImageUtil;
import mn.zxing.view.ViewfinderView;
...
public abstract class BaseScanActivity extends AppCompatActivity implements SurfaceHolder.Callback, ScanResultLinstener {
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (result == null || TextUtils.isEmpty(result.getText())) {
            ...
            onQrAnalyzeSuccess(result, barcode);
        }
    }
    ...
    public abstract void onQrAnalyzeSuccess(Result result, Bitmap barcode);
}
